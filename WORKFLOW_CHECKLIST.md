...
- Blocker nếu có:
  - none.
- Bước kế tiếp:
  - mở batch434 với 1 micro-slice product seam tiếp theo (ưu tiên direct messaging hoặc friend-graph parity token còn thiếu), giữ verify tối thiểu `swift build` + `make test-friendships`.
