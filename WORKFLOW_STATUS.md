...
- Scope: batch 194 iOS inbox seam hardening — add quick-copy one-line summary `branch + use_when + preview`
- Status: verify
- Files:
...
- Git:
  - latest commit: `2875af4` — `batch194: add branch-use-when-preview quick copy`
  - working tree: sạch (sau commit local, chưa push)
- Blocker: none
- Next: mở batch195 cho messaging friction tiếp theo (ví dụ thêm quick-copy block summary có tag header + `branch/use_when/preview` để dán nguyên cụm vào ticket note) trong iOS inbox shell
