...
- Scope: batch 313 feed shell (web+iOS) — add `delete_summary_copy_source=quick_delete_parity|last_delete_result|copied_feedback` marker into delete-summary copy success status/log text for copy-source auditability.
- Status: complete
...
- Blocker: none
- Next: mở batch314 với 1 slice hẹp feed shell (web+iOS) — bổ sung quick-copy line `delete_copy_audit=source:.../value:...` để gom audit payload thành 1 token ngắn, tránh phải parse status sentence dài khi report thủ công.
- Batch 295 handoff:
