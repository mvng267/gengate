...
- Scope: batch 109 iOS inbox seam hardening — add inline cursor ordering/unread-behind hints in member summary
- Status: verify
- Files:
...
- Git:
  - latest commit: `HEAD` (local batch109 slice)
  - working tree: sạch (sau commit local, chưa push)
- Blocker: none
- Next: mở batch110 cho messaging friction tiếp theo (ví dụ quick jump action to first unread candidate) trong iOS inbox shell
