...
- Scope: batch 354 friend graph shell (web) — add one-tap quick-copy friend-request create+accept bundle line for happy-path parity report.
- Status: complete
...
- Git:
  - latest feature commit: `e306089` — `batch354: add friend-request create-accept bundle quick copy in web friend graph shell`
  - previous feature commit: `b4db83c` — `batch353: add lifecycle pair mutation quick copy in ios notification shell`
  - working tree: clean
- Blocker: none
- Next: mở batch355 với 1 slice hẹp friend graph shell (iOS): thêm quick-copy friend-request create+accept bundle line để parity với web batch354.
- Batch 354 handoff:
