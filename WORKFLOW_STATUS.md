...
- Scope: batch 310 feed shell (web+iOS) — add quick-copy actions for delete parity summaries (`Quick delete parity summary` + `Last delete result summary`) to speed up human create->delete reporting.
- Status: complete
...
- Blocker: none
- Next: mở batch311 với 1 slice hẹp feed shell (web+iOS) — thêm `delete_snapshot_source=manual_input|preset_row|first_authored_quick_pick` marker vào quick delete parity summary để trace nguồn delete target rõ hơn khi human test.
- Batch 295 handoff:
