...
- Scope: batch 191 iOS inbox seam hardening — add quick-copy for source-hint `preview-pair-lite` use_when line
- Status: verify
- Files:
...
- Git:
  - latest commit: `77b9a9e` — `batch191: add preview-pair-lite use-when line quick copy`
  - working tree: sạch (sau commit local, chưa push)
- Blocker: none
- Next: mở batch192 cho messaging friction tiếp theo (ví dụ thêm quick-copy riêng cho block `use_when + preview` dạng 1-line condensed để paste issue title/body cực gọn) trong iOS inbox shell
