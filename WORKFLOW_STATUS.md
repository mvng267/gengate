...
- Scope: batch 180 iOS inbox seam hardening — add compact preview for triage-kit payload
- Status: verify
- Files:
...
- Git:
  - latest commit: `HEAD` (local batch180 slice)
  - working tree: sạch (sau commit local, chưa push)
- Blocker: none
- Next: mở batch181 cho messaging friction tiếp theo (ví dụ thêm quick-copy compact triage-kit preview line) trong iOS inbox shell
