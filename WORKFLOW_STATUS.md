...
- Scope: batch 193 iOS inbox seam hardening — add quick-copy for source-hint branch-preview short token
- Status: verify
- Files:
...
- Git:
  - latest commit: `5186d25` — `batch193: add branch-preview token quick copy`
  - working tree: sạch (sau commit local, chưa push)
- Blocker: none
- Next: mở batch194 cho messaging friction tiếp theo (ví dụ thêm quick-copy block `branch + use_when + preview` gọn 1 dòng cho summary heading trong ticket) trong iOS inbox shell
