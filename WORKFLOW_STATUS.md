...
- Scope: batch 192 iOS inbox seam hardening — add quick-copy for source-hint `preview-pair-lite` condensed one-line block
- Status: verify
- Files:
...
- Git:
  - latest commit: `06f8ccb` — `batch192: add preview-pair-lite condensed quick copy`
  - working tree: sạch (sau commit local, chưa push)
- Blocker: none
- Next: mở batch193 cho messaging friction tiếp theo (ví dụ thêm quick-copy riêng cho short token `branch-key + preview` để paste nhanh vào issue labels/summary) trong iOS inbox shell
