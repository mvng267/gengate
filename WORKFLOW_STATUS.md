...
- Scope: batch 177 iOS inbox seam hardening — add inline usage guidance for triage line/body/diff-hint
- Status: verify
- Files:
...
- Git:
  - latest commit: `HEAD` (local batch177 slice)
  - working tree: sạch (sau commit local, chưa push)
- Blocker: none
- Next: mở batch178 cho messaging friction tiếp theo (ví dụ thêm copy-ready usage-note line để paste vào bug report template) trong iOS inbox shell
