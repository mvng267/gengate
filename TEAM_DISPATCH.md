...
- Trục công việc: feed shell — web+iOS persist/display `last_source_state_snapshot=...` token after source-state snapshot copy.
- Trạng thái: batch322_complete_feed_source_state_snapshot_token_web_ios.
