...
- Trục công việc: friend-graph shell — web/iOS include inbound/outbound pending breakdown in load status text.
- Trạng thái: batch257_complete_friend_graph_pending_breakdown_status_text.
