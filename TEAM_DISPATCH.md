...
- Trục công việc: direct-message shell — web+iOS add quick-copy read-cursor focus summary (`focus_user + resolved_message + read_state`).
- Trạng thái: batch268_complete_dm_read_cursor_quick_copy_summary_web_ios.
