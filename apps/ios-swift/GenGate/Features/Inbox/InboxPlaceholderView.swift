...
"""
    ...
    private func copyLastSendQuickCopyResult() {
        ...
        guard writeToClipboard(normalizedText) else {
            sendStatusHint = "send_result_quick_copy_failed"
            return
        }
    ...
    private func copySenderKeepPairQuickCopySummary() {
        ...
        guard writeToClipboard(normalizedText) else {
            sendStatusHint = "sender_keep_pair_quick_copy_failed"
            return
        }
    ...
    private func copySenderKeepPairAndSendResultBundleQuickCopySummary() {
        ...
        guard writeToClipboard(normalizedText) else {
            sendStatusHint = "sender_keep_pair_send_bundle_quick_copy_failed"
            return
        }
    ...
    private func copyReadCursorQuickCopySummary() {
        ...
        guard writeToClipboard(normalizedText) else {
            sendStatusHint = "read_cursor_quick_copy_failed"
            return
        }
    ...
    private func copyReadCursorTriageQuickCopySummary() {
        ...
        guard writeToClipboard(normalizedText) else {
            sendStatusHint = "read_cursor_triage_quick_copy_failed"
            return
        }
    ...
    private func copyFirstUnreadGuardQuickCopySummary() {
        ...
        guard writeToClipboard(normalizedText) else {
            sendStatusHint = "first_unread_guard_quick_copy_failed"
            return
        }
